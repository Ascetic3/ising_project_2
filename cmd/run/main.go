...
func run() (err error) {
	...
	for rowIndex := 0; ; rowIndex++ {
		...
		if err != nil {
			return fmt.Errorf("simulation failed for L=%d, J=[%.3f %.3f %.3f %.3f %.3f %.3f], h=%.3f: %w",
				params.L, params.J1, params.J2, params.J3, params.J4, params.J5, params.J6, params.H, err)
		}
